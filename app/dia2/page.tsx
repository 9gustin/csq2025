...
function Schedule() {
  ...
  const locations = [...new Set(DATA_DAY2.map(show => show.location))];
  ...
  const isShowDay = currentTime.getDate() === 16 && 
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-4 space-y-1 text-sm">
          <div className="text-gray-600">
            * Shows después de medianoche (17 de Febrero)
          </div>
          {isShowDay && (
            <div className="text-gray-600">
              🔜 Próximos 30 minutos
